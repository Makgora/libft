# libft
Premier projet de l'école 42 qui consiste à recoder une partie des fonctions de la lib C vues lors de l'examen d'entrée afin de créer la lib personelle : `libft.a`

## Partie 1
Consulter le `man` relatif à chaque fonction pour obetenir leur description.
* ft_memset
* ft_bzero
* ft_memcpy
* ft_memccpy
